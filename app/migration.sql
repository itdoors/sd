...
-- email templates
INSERT INTO "public".email ("alias", subject, text) 
	VALUES ('decision-result', 'Результат решения', '<table>
 <tbody><tr>
  <td align="center" valign="top">
   <table align="center" style="width: 100%;background: #1f1f1f;">
    <tbody><tr>
     <td style="text-align: center;" align="center">
      <table style="width: 585px;margin: 0 auto;text-align: inherit;" align="center">
       <tbody><tr>
        <td>
          <table style="display: block;padding: 0px;width: 100%;position: relative;vertical-align: top;text-align: left;
">
          <tbody><tr>
           <td style="padding: 10px 20px 0px 0px;
position: relative;;vertical-align: middle;">
             <table style="width: 280px;">
              <tbody><tr>
               <td style="padding: 0px 0px 10px;vertical-align: middle;">
  <a href="http://www.griffin.ua" style="background-image: url(http://sd.griffin.ua/templates/core/img/logo-small-gray.png);outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;width: auto;height: auto;max-width: none !important;float: left;clear: both;display: block;width: 104px;height: 14px;">
</a>
                                                        </td>
                                                    </tr>
                                                </tbody></table>
                                            ...
                                            <td style="padding-right: 0px;padding: 10px 20px 0px 0px;
position: relative;vertical-align: middle;">
                                                <table style="width: 280px;">
                                                    <tbody><tr>
                                                        <td>
                                                            <table align="right" style="float: right;vertical-align: top;
text-align: left;">
                                                                <tbody><tr>
                                                                    <td style="padding-top: 0;padding-bottom: 0;vertical-align: middle;padding: 0 2px !important;width: auto !important;">                                                                   <a href="//www.facebook.com/pages/%D0%98%D0%BC%D0%BF%D0%B5%D0%BB-%D0%93%D1%80%D0%B8%D1%84%D1%84%D0%B8%D0%BD/191430010917393" style="background-image: url(http://t.itdoors.com.ua/templates/metronic/img/social/facebook.png);outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;width: auto;height: auto;max-width: none !important;float: left;clear: both;display: block;width: 30px;height: 30px;background-repeat: no-repeat;background-position-y: -38px;">                                                                  </a>
</td>
                                                                    <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;padding: 0 2px !important;width: auto !important;">                                                                    <a href="https://twitter.com/ImpelGriffin" style="background-image: url(http://t.itdoors.com.ua/templates/metronic/img/social/twitter.png);outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;width: auto;height: auto;max-width: none !important;float: left;clear: both;display: block;width: 30px;height: 30px;background-repeat: no-repeat;background-position-y: -38px;">                                                              </a>                                                      </td>
...
<a href="https://plus.google.com/+GriffinUa/posts" style="background-image: url(http://t.itdoors.com.ua/templates/metronic/img/social/googleplus.png);outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;width: auto;height: auto;max-width: none !important;float: left;clear: both;display: block;width: 30px;height: 30px;background-repeat: no-repeat;background-position-y: -38px;">                                                                                                                                 </a>                                                         </td>
            ...
            <div style="text-align: left;"><br></div><br><table align="center" style="width: 580px;
margin: 0 auto;
text-align: inherit;">
                <tbody><tr>
...
margin: 5px 0 15px 0;">Результаты о принятии решения № ${id}$</h4>
    <p>
     ${lastName}$ ${firstName}$ ${middleName}$ приглашал Вас оставить мнение о решении номер: ${id}$ дата:  ${datePublic}$ ${title}$.
<br>
Срок принятия решения исчерпан. <br><br>
Результат решения вы можете посмотреть по ссылке:
   </p>
                                   
                                    <table style="margin-bottom: 10px;width: 580px">
                                        <tbody><tr>
                                            <td class="panel" style="padding: 10px !important;
background: #ECF8FF;
border: 0;"><span style="color: rgb(22, 52, 59); font-family: Arial; font-size: 12px; line-height: 15px; background-color: rgb(255, 255, 225);">${url}$</span><br></td>
                                            <td class="expander">
                                            </td>
                                        </tr>
                                    </tbody></table>
                                    <p>
                                       Если переход по ссылке не работает, скопируйте и вставьте ссылку в адресную строку браузера.
                                    </p>
                                </td>
                            </tr>
                        </tbody></table>
...
display: block;">
            ...
            <table align="center" style="width: 100%;background: #2f2f2f;">
                <tbody><tr>
                    <td align="center" style="vertical-align: middle;color: #fff;text-align: center;">
                        <table style="width: 590px;margin: 0 auto;text-align: inherit;" align="center">
                            <tbody><tr>
                                <td>
                                    <table style="display: block;padding: 0px;
width: 100%;
position: relative;vertical-align: top;
text-align: left;">
                                        <tbody><tr>
                                            <td style="vertical-align: middle;color: #fff;padding: 10px 20px 0px 0px;text-align: left;"><span style="font-size:12px;"><i>Это письмо автоматически создано системой ImpelNET. Отвечать на него нет необходимости.</i></span>
                                            </td>
                                        </tr>
                                    </tbody></table>
                                    <table style="
                                        ...
                                        <tbody><tr>
                                            <td style="vertical-align: middle;color: #fff;">
                                                <table class="four columns">
                                                    <tbody><tr>
                                                        <td style="padding-top: 0;padding-bottom: 0;vertical-align: middle;color: #fff;">  (c) Impel Griffin Group 1995-2014   </td>
                                                    </tr>
                                                </tbody></table>
                                            </td>
                                            <td style="vertical-align: middle;color: #fff;">
...
<a href="http://www.griffin.ua" style="cursor" pointer"="">
                                                                О нас</a>
                                                        </td>
                                                    </tr>
                                                </tbody></table>
...
INSERT INTO "public".email ("alias", subject, text) 
	VALUES ('decision-making-only-15-minutes', 'Решение. Поторопитесь!!! Осталось 15 минут.', '<table>
 <tbody><tr>
  <td align="center" valign="top">
   <table align="center" style="width: 100%;background: #1f1f1f;">
    <tbody><tr>
...
position: relative;">
<h4 style="display: block;
margin: 5px 0 15px 0;">Вас пригласили поучаствовать в принятии решения № ${id}$</h4>
    <p>
     ${lastName}$ ${firstName}$ ${middleName}$ пригласил Вас оставить мнение о решении номер: ${id}$ дата:  ${datePublic}$ ${title}$.
<br>
Конечный срок принятия решения <b>${dateUnpublic}$</b>.
<br><br><span style="font-weight: bold;">У Вас осталось 15 минут!</span><br><br>
Пожалуйста, перейдите по ссылке, чтобы оставить решение:
   </p>
...
INSERT INTO "public".email ("alias", subject, text) 
	VALUES ('decision-making', 'Приглашение принять решение № ${id}$', '<table>
 <tbody><tr>
  <td align="center" valign="top">
   <table align="center" style="width: 100%;background: #1f1f1f;">
    <tbody><tr>
