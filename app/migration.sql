...
CREATE TABLE project_message (id SERIAL NOT NULL, project_id INT DEFAULT NULL, type_id INT DEFAULT NULL, user_id INT DEFAULT NULL, contact_id BIGINT DEFAULT NULL, create_datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, description TEXT DEFAULT NULL, event_datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_datetime TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, discriminator VARCHAR(255) NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE project_commercial_tender_service (project_id INT NOT NULL, service_id INT NOT NULL, PRIMARY KEY(project_id, service_id));
CREATE INDEX IDX_EC37C904166D1F9C ON project_commercial_tender_service (project_id);
CREATE INDEX IDX_EC37C904ED5CA9E6 ON project_commercial_tender_service (service_id);
CREATE TABLE project_file_type (id BIGSERIAL NOT NULL, alias VARCHAR(64) DEFAULT NULL, name VARCHAR(128) NOT NULL, "group" VARCHAR(64) NOT NULL, PRIMARY KEY(id));
...
CREATE INDEX IDX_B50EFE08A76ED395 ON project_file (user_id);
CREATE INDEX IDX_B50EFE08166D1F9C ON project_file (project_id);
CREATE INDEX IDX_B50EFE08C54C8C93 ON project_file (type_id);
...
ALTER TABLE project_commercial_tender_service ADD CONSTRAINT FK_EC37C904166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE project_commercial_tender_service ADD CONSTRAINT FK_EC37C904ED5CA9E6 FOREIGN KEY (service_id) REFERENCES project_service (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE project_file ADD user_id INT DEFAULT NULL;
...
ALTER TABLE project ALTER is_closed DROP NOT NULL;
ALTER TABLE project_file ADD CONSTRAINT FK_B50EFE08A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE project_file ADD CONSTRAINT FK_B50EFE08166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE project_file ADD CONSTRAINT FK_B50EFE08C54C8C93 FOREIGN KEY (type_id) REFERENCES project_file_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE project_file ADD CONSTRAINT FK_B50EFE08537A1329 FOREIGN KEY (message_id) REFERENCES project_message (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE project ADD status_id INT DEFAULT NULL;
