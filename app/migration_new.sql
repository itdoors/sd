...
CREATE TABLE claims_curators (claim_id INT NOT NULL, stuff_id BIGINT NOT NULL, PRIMARY KEY(claim_id, stuff_id));
...
CREATE TABLE claims_performers (claim_id INT NOT NULL, stuff_id BIGINT NOT NULL, PRIMARY KEY(claim_id, stuff_id));
...
ALTER TABLE claims_curators ADD CONSTRAINT FK_1EAC26FF950A1740 FOREIGN KEY (stuff_id) REFERENCES stuff (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE claims_performers ADD CONSTRAINT FK_90BB305A950A1740 FOREIGN KEY (stuff_id) REFERENCES stuff (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
