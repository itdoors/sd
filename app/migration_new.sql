...
ALTER TABLE sd_claim_message ADD CONSTRAINT FK_8BFA8A96A76ED395 FOREIGN KEY (user_id) REFERENCES sd_business_role (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE organization_granted_for_order_departments ADD CONSTRAINT FK_776A15FB2DA3DEF9 FOREIGN KEY (org_granted_for_order_id) REFERENCES org_granted_for_order (id) NOT DEFERRABLE INITIALLY IMMEDIATE;
