...
ALTER TABLE sd_claim ADD akt_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL;
ALTER TABLE sd_claim ADD bill_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL;
ALTER TABLE sd_claim ADD akt TEXT DEFAULT NULL;
ALTER TABLE sd_claim ADD smeta TEXT DEFAULT NULL;
ALTER TABLE sd_claim ADD smeta_cost TEXT DEFAULT NULL;
