...
////
////        /** @var \Lists\ContactBundle\Repository\InvoiceRepository $handlingRepository */
...
//        return $this->render('ITDoorsControllingBundle:' . $this->baseTemplate . ':index.html.twig', array(
...
//
//        $entities30 = $em->getRepository('ITDoorsControllingBundle:Invoice')->findAllOrderedByName();
//        $entities30 = $this->getDoctrine()
//            ->getRepository('ITDoorsControllingBundle:Invoice')->getInvoicePeriod(30);
