...
namespace ITDoors\CronBundle\Controller;

use BCC\CronManagerBundle\Controller\DefaultController as ManagerCron;
    ...
    public function addAction()
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('it_doors_cron_index'));
            }
        }
