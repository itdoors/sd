...
class Handling
{
     ...
     * Add files
     *
     * @param \Lists\HandlingBundle\Entity\ProjectFile $files
     *
     * @return Handling
     */
    public function addFile (\Lists\HandlingBundle\Entity\ProjectFile $files)
    {
        $this->files[] = $files;
     ...
     * @param \Lists\HandlingBundle\Entity\ProjectFile $files
     */
    public function removeFile (\Lists\HandlingBundle\Entity\ProjectFile $files)
    {
