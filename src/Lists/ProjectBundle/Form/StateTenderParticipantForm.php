...
/**
 * Class StateTenderParticipantForm
 */
class StateTenderParticipantForm extends AbstractType
{
    protected $em;
    protected $router;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
         $builder
            ...
            ->add('stateTender', 'entity', array(
                'class' => 'ListsProjectBundle:StateTender'
                )
            )
            ->add('summa', 'text')
            ->add('reason', 'textarea')
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Lists\ProjectBundle\Entity\StateTenderParticipant',
    ...
    {
        return 'stateTenderParticipantForm';
    }
}
