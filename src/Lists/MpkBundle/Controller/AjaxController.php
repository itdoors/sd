...
class AjaxController extends Controller
{
     ...
     * @return string
     */
    public function searchMpkAction(Request $request)
    {
        $searchText = $request->query->get('query');

        /** @var \Lists\MpkBundle\Entity\MpkRepository $objects */
        $objects = $this->getDoctrine()
            ->getRepository('ListsMpkBundle:Mpk')
            ->getSearchQueryMpk($searchText);
    ...
    public function mpkByIdsAction(Request $request)
    {
        ...
        /** @var \Lists\MpkBundle\Entity\MpkRepository $mpkRepository */
